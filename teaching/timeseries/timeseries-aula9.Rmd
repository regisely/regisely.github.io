...
onde $\Gamma_i = \Phi_1 + \ldots + \Phi_p - I_n$, sendo $\Phi_k$ a matriz dos coeficientes do modelo VAR, e $\mathbf{D_t}$ uma expressão que contém componentes determinísticos (interceptos e tendências)
