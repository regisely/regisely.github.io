...
```{r read1, eval=FALSE, echo=TRUE, message=FALSE}
pnad <- read_csv(
...
```{r read2, eval=TRUE, echo=FALSE, message=FALSE}
pnad <- read_csv(
...
```{r estados1, eval=TRUE, echo=FALSE, message=FALSE}
estados <- read_excel(
...
```{r estados2, eval=FALSE, echo=TRUE, message=FALSE}
estados <- read_excel(
