...
Este código simula e estima vários processos ARMA através de funções log-verossimilhança próprias e através de funções internas do R, comparando os resultados. No final do código também é feito um exemplo das etapas de diagnóstico e previsão da Metodologia de Box-Jenkins.
